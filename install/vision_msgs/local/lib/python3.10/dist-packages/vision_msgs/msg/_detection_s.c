...
bool vision_msgs__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._detection.Detection", full_classname_dest, 36) == 0);
  }
  vision_msgs__msg__Detection * ros_message = _ros_message;
  {  // class_name
...
PyObject * vision_msgs__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._detection");
