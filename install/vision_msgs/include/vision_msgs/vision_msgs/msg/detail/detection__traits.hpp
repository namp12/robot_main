...
#ifndef VISION_MSGS__MSG__DETAIL__DETECTION__TRAITS_HPP_
#define VISION_MSGS__MSG__DETAIL__DETECTION__TRAITS_HPP_
...
inline void to_yaml(
  const vision_msgs::msg::Detection & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const vision_msgs::msg::Detection & msg)
{
  return vision_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vision_msgs::msg::Detection>()
{
  return "vision_msgs::msg::Detection";
}

template<>
inline const char * name<vision_msgs::msg::Detection>()
{
  return "vision_msgs/msg/Detection";
}

template<>
struct has_fixed_size<vision_msgs::msg::Detection>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vision_msgs::msg::Detection>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<vision_msgs::msg::Detection>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VISION_MSGS__MSG__DETAIL__DETECTION__TRAITS_HPP_
