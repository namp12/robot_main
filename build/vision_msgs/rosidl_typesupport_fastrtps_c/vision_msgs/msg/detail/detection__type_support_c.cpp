...
#include "vision_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
using _Detection__ros_msg_type = vision_msgs__msg__Detection;
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Detection(
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__Detection(
