...
bool vision_msgs__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * vision_msgs__msg__detection__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool vision_msgs__msg__detection_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._detection_array.DetectionArray", full_classname_dest, 47) == 0);
  }
  vision_msgs__msg__DetectionArray * ros_message = _ros_message;
  {  // header
  ...
  {  // detections
    ...
    if (!vision_msgs__msg__Detection__Sequence__init(&(ros_message->detections), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create vision_msgs__msg__Detection__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    vision_msgs__msg__Detection * dest = ros_message->detections.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!vision_msgs__msg__detection__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * vision_msgs__msg__detection_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._detection_array");
  ...
  {  // detections
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = vision_msgs__msg__detection__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
