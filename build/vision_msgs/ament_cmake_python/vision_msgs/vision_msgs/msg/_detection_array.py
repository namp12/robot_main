    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vision_msgs.msg.DetectionArray')
            logger.debug(
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<vision_msgs/Detection>',
        'image_width': 'int32',
        'image_height': 'int32',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vision_msgs', 'msg'], 'Detection')),  # noqa: E501
