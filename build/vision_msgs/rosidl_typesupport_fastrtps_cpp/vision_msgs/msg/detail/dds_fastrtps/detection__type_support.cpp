...
#include "vision_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs::msg::Detection & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
...
{
  auto typed_message =
    static_cast<const vision_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, Detection)() {
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
