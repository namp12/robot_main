...
#include "vision_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vision_msgs::msg::Detection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vision_msgs::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs::msg::DetectionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, DetectionArray)() {
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
