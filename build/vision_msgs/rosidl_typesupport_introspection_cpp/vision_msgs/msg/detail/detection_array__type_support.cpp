...
{
  new (message_memory) vision_msgs::msg::DetectionArray(_init);
}

void DetectionArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vision_msgs::msg::DetectionArray *>(message_memory);
  typed_message->~DetectionArray();
}

size_t size_function__DetectionArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<vision_msgs::msg::Detection> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<vision_msgs::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<vision_msgs::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const vision_msgs::msg::Detection *>(
    get_const_function__DetectionArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<vision_msgs::msg::Detection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<vision_msgs::msg::Detection *>(
    get_function__DetectionArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const vision_msgs::msg::Detection *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionArray_message_member_array[5] = {
  {
    ...
    offsetof(vision_msgs::msg::DetectionArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<vision_msgs::msg::Detection>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::DetectionArray, detections),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::DetectionArray, image_width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::DetectionArray, image_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::DetectionArray, inference_time_ms),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionArray_message_members = {
  ...
  5,  // number of fields
  sizeof(vision_msgs::msg::DetectionArray),
...
get_message_type_support_handle<vision_msgs::msg::DetectionArray>()
{
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_msgs, msg, DetectionArray)() {
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
